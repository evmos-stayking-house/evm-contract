...
export interface InterestBearingTokenInterface extends utils.Interface {
  functions: {
...
export interface InterestBearingToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InterestBearingTokenInterface;
