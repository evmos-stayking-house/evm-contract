...
export type ERC20OwnableCraftFactory = CraftFactory<Configs.ERC20OwnableConfig, Crafts.ERC20OwnableCraft, Deploy.ERC20OwnableDeployArgs>;
export type ERC20UpgradeableCraftFactory = CraftFactory<Configs.ERC20UpgradeableConfig, Crafts.ERC20UpgradeableCraft, Deploy.ERC20UpgradeableDeployArgs>;
export type InitializableCraftFactory = CraftFactory<Configs.InitializableConfig, Crafts.InitializableCraft, Deploy.InitializableDeployArgs>;
export type OwnableCraftFactory = CraftFactory<Configs.OwnableConfig, Crafts.OwnableCraft, Deploy.OwnableDeployArgs>;
